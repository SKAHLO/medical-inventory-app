...
// import { mockItems, mockSuppliers, mockTransactions } from "@/lib/mock-data"
...
export default function InventoryPage() {
  ...
  const handleStockAction = (item: InventoryItem, action: string) => {
    console.log(`Stock action: ${action}`, item)
    // You can hook into /api/items/[id] later here for PUT or DELETE
  }
  ...
  if (items.length === 0) {
    return <div className="p-6 text-gray-500">No inventory items available.</div>
  }
